...
export default function ClientDetailScreen() {
  ...
  const handleEditPress = (sheet: TechnicalSheet) => {
    ...
    // Find service by name and set price
    const svc = services.find(s => s.name === sheet.service);
    setEditSelectedServiceId(svc ? svc.id : null);
    setEditSelectedServicePrice(sheet.price || (svc ? svc.price : 0));
  ...
  const handleSaveEdit = async () => {
    ...
    try {
      ...
      formData.append('price', editSelectedServicePrice.toString());
  ...
  const handleCreateSheet = async () => {
    ...
    try {
      ...
      setShowCreateDatePicker(false);
      formData.append('date', tempDate);
      formData.append('price', selectedServicePrice.toString());
            ...
            <View style={styles.card}>
              <View style={styles.cardHeader}>
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center', flex: 1, justifyContent: 'space-between', marginBottom: 5, width: '100%' }}>
                  ...
                  {item.price && (
                    <Text style={{ color: '#43a047', fontSize: 14, fontWeight: '600', marginLeft: 10 }}>
